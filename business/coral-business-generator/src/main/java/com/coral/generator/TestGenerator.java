...
public class TestGenerator {
    //填写项目名称
    public static final String FILE_PATH = "test-payment";

    //设置包名
    public static final String PACKAGE_NAME = "com.coral.payment";

    //作者
    public static final String AUTHOR = "sunyixing";

    //设置数据库地址
    public static final String  DATABASE_PATH= "localhost:3306";
    ...
    //数据库密码
    public static final String DATABASE_PASSWORD = "SUNYIXING";

    //设置表名前缀
    public static final String TABLE_PREFIX = "cr_";

    //生成数据库的表
    public static final String TABLE = "cr_test";
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/" + FILE_PATH + "/src/main/java");
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return projectPath + "/" + FILE_PATH + "/src/main/resources/mapper/"
