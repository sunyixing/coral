 ...
 *
 */
public class WkfGenerator {

    //一级目录名
    public static final String FIRST_FILE_PATH = "business";

    //填写项目名称
    public static final String FILE_PATH = "coral-business-register-helper";

    //设置包名
    public static final String PACKAGE_NAME = "com.coral.business";

    //作者
    public static final String AUTHOR = "kaifeng";
    ...
    //生成数据库的表
    public static final String TABLE = "cr_merchant_user,cr_wechat_info";
    ...
    public static void main(String[] args) {
        ...
        gc.setFileOverride(false); //是否生成已有文件
